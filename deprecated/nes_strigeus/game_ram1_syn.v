...
//altsyncram CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone V" ENABLE_RUNTIME_MOD="YES" INSTANCE_NAME="RAM1" NUMWORDS_A=8192 OPERATION_MODE="SINGLE_PORT" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="UNREGISTERED" POWER_UP_UNINITIALIZED="FALSE" read_during_write_mode_port_a="NEW_DATA_NO_NBE_READ" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=13 address_a clock0 data_a q_a rden_a wren_a
...
endmodule //game_ram1_altsyncram1

//synthesis_resources = M10K 8 sld_mod_ram_rom 1 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  game_ram1_altsyncram
	( 
	address_a,
	clock0,
	data_a,
...
`endif
	...
	game_ram1_altsyncram1   altsyncram1
	( 
	.address_a(address_a),
	...
	assign
		q_a = wire_altsyncram1_q_a;
endmodule //game_ram1_altsyncram
//VALID FILE
...
`endif
	...
	game_ram1_altsyncram	game_ram1_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.data_a (data),
				.rden_a (rden),
